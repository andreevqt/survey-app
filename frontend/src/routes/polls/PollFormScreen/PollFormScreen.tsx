...
import { usePollFormScreen } from './hooks/usePollFormScreen';
import type { PollFormScreenProps } from './types';

export function PollFormScreen(_props: PollFormScreenProps = {}) {
  const vm = usePollFormScreen();
  ...
  return (
    <section className="max-w-3xl mx-auto py-12 px-6">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">{vm.heading}</h1>
